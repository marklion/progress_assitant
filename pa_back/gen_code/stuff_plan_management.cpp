...
uint32_t stuff_plan_management_get_created_plan_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<plan_status> ::const_iterator _iter307;
...
uint32_t stuff_plan_management_get_company_plan_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<plan_status> ::const_iterator _iter318;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->deliver_infos.resize(_size324);
            uint32_t _i328;
            for (_i328 = 0; _i328 < _size324; ++_i328)
            {
              xfer += this->deliver_infos[_i328].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t stuff_plan_management_confirm_deliver_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("deliver_infos", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    std::vector<deliver_info> ::const_iterator _iter329;
    for (_iter329 = this->deliver_infos.begin(); _iter329 != this->deliver_infos.end(); ++_iter329)
    {
...
uint32_t stuff_plan_management_confirm_deliver_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*(this->deliver_infos)).size()));
    std::vector<deliver_info> ::const_iterator _iter330;
    for (_iter330 = (*(this->deliver_infos)).begin(); _iter330 != (*(this->deliver_infos)).end(); ++_iter330)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->plan_ids.resize(_size331);
            uint32_t _i335;
            for (_i335 = 0; _i335 < _size331; ++_i335)
            {
              xfer += iprot->readI64(this->plan_ids[_i335]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t stuff_plan_management_export_plan_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("plan_ids", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<int64_t> ::const_iterator _iter336;
    for (_iter336 = this->plan_ids.begin(); _iter336 != this->plan_ids.end(); ++_iter336)
    {
      xfer += oprot->writeI64((*_iter336));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
uint32_t stuff_plan_management_export_plan_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("plan_ids", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter337 = (*(this->plan_ids)).begin(); _iter337 != (*(this->plan_ids)).end(); ++_iter337)
    {
...
uint32_t stuff_plan_management_search_plan_by_driver_phone_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<plan_number_id> ::const_iterator _iter343;
...
uint32_t stuff_plan_management_get_status_rule_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<plan_status_rule> ::const_iterator _iter354;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readBool(this->success[_i364]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
...
uint32_t stuff_plan_management_get_change_rule_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<bool> ::const_iterator _iter365;
      for (_iter365 = this->success.begin(); _iter365 != this->success.end(); ++_iter365)
      {
        xfer += oprot->writeBool((*_iter365));
      }
      xfer += oprot->writeListEnd();
    }
    xfer += oprot->writeFieldEnd();
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readBool((*(this->success))[_i370]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
...
uint32_t stuff_plan_management_get_today_statistics_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<vichele_statistics> ::const_iterator _iter376;
...
uint32_t stuff_plan_management_search_plan_by_vichele_number_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<vichele_search_result> ::const_iterator _iter387;
...
uint32_t stuff_plan_management_get_tomorrow_statistics_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<vichele_statistics> ::const_iterator _iter398;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->ids.resize(_size404);
            uint32_t _i408;
            for (_i408 = 0; _i408 < _size404; ++_i408)
            {
              xfer += iprot->readI64(this->ids[_i408]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t stuff_plan_management_cancel_vichele_from_plan_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("ids", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter409 = this->ids.begin(); _iter409 != this->ids.end(); ++_iter409)
    {
...
uint32_t stuff_plan_management_cancel_vichele_from_plan_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("ids", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter410 = (*(this->ids)).begin(); _iter410 != (*(this->ids)).end(); ++_iter410)
    {
...
stuff_plan_management_driver_silent_reset_args::~stuff_plan_management_driver_silent_reset_args() noexcept {
}


uint32_t stuff_plan_management_driver_silent_reset_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t stuff_plan_management_driver_silent_reset_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("stuff_plan_management_driver_silent_reset_args");

  xfer += oprot->writeFieldBegin("ssid", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->ssid);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("silent_id", ::apache::thrift::protocol::T_STRING, 2);
  xfer += oprot->writeString(this->silent_id);
  xfer += oprot->writeFieldEnd();
...
stuff_plan_management_driver_silent_reset_pargs::~stuff_plan_management_driver_silent_reset_pargs() noexcept {
}


uint32_t stuff_plan_management_driver_silent_reset_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("stuff_plan_management_driver_silent_reset_pargs");
...
stuff_plan_management_driver_silent_reset_result::~stuff_plan_management_driver_silent_reset_result() noexcept {
}


uint32_t stuff_plan_management_driver_silent_reset_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t stuff_plan_management_driver_silent_reset_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("stuff_plan_management_driver_silent_reset_result");
...
stuff_plan_management_driver_silent_reset_presult::~stuff_plan_management_driver_silent_reset_presult() noexcept {
}


uint32_t stuff_plan_management_driver_silent_reset_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t stuff_plan_management_get_today_driver_info_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<today_driver_info> ::const_iterator _iter416;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->plan_ids.resize(_size422);
            uint32_t _i426;
            for (_i426 = 0; _i426 < _size422; ++_i426)
            {
              xfer += iprot->readI64(this->plan_ids[_i426]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.plan_ids = true;
...
uint32_t stuff_plan_management_multi_confirm_plan_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I64, static_cast<uint32_t>(this->plan_ids.size()));
    std::vector<int64_t> ::const_iterator _iter427;
    for (_iter427 = this->plan_ids.begin(); _iter427 != this->plan_ids.end(); ++_iter427)
    {
      xfer += oprot->writeI64((*_iter427));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
uint32_t stuff_plan_management_multi_confirm_plan_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I64, static_cast<uint32_t>((*(this->plan_ids)).size()));
    std::vector<int64_t> ::const_iterator _iter428;
    for (_iter428 = (*(this->plan_ids)).begin(); _iter428 != (*(this->plan_ids)).end(); ++_iter428)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->plan_id.resize(_size429);
            uint32_t _i433;
            for (_i433 = 0; _i433 < _size429; ++_i433)
            {
              xfer += iprot->readI64(this->plan_id[_i433]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.plan_id = true;
...
uint32_t stuff_plan_management_change_plan_price_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("plan_id", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter434 = this->plan_id.begin(); _iter434 != this->plan_id.end(); ++_iter434)
    {
...
uint32_t stuff_plan_management_change_plan_price_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("plan_id", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter435 = (*(this->plan_id)).begin(); _iter435 != (*(this->plan_id)).end(); ++_iter435)
    {
...
void stuff_plan_managementClient::driver_silent_reset(const std::string& ssid, const std::string& silent_id)
{
  send_driver_silent_reset(ssid, silent_id);
  recv_driver_silent_reset();
}

void stuff_plan_managementClient::send_driver_silent_reset(const std::string& ssid, const std::string& silent_id)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("driver_silent_reset", ::apache::thrift::protocol::T_CALL, cseqid);

  stuff_plan_management_driver_silent_reset_pargs args;
  args.ssid = &ssid;
  args.silent_id = &silent_id;
  args.write(oprot_);
...
void stuff_plan_managementClient::recv_driver_silent_reset()
{
  ...
  if (fname.compare("driver_silent_reset") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  stuff_plan_management_driver_silent_reset_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void stuff_plan_managementProcessor::process_driver_silent_reset(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("stuff_plan_management.driver_silent_reset", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "stuff_plan_management.driver_silent_reset");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "stuff_plan_management.driver_silent_reset");
  }

  stuff_plan_management_driver_silent_reset_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "stuff_plan_management.driver_silent_reset", bytes);
  }

  stuff_plan_management_driver_silent_reset_result result;
  try {
    iface_->driver_silent_reset(args.ssid, args.silent_id);
  } catch (gen_exp &e) {
    result.e = e;
    result.__isset.e = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "stuff_plan_management.driver_silent_reset");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("driver_silent_reset", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "stuff_plan_management.driver_silent_reset");
  }

  oprot->writeMessageBegin("driver_silent_reset", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "stuff_plan_management.driver_silent_reset", bytes);
  }
}
...
void stuff_plan_managementConcurrentClient::driver_silent_reset(const std::string& ssid, const std::string& silent_id)
{
  int32_t seqid = send_driver_silent_reset(ssid, silent_id);
  recv_driver_silent_reset(seqid);
}

int32_t stuff_plan_managementConcurrentClient::send_driver_silent_reset(const std::string& ssid, const std::string& silent_id)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("driver_silent_reset", ::apache::thrift::protocol::T_CALL, cseqid);
...
void stuff_plan_managementConcurrentClient::recv_driver_silent_reset(const int32_t seqid)
{
