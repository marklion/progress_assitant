...
vichele_management_get_bound_stuff_args::~vichele_management_get_bound_stuff_args() noexcept {
}


uint32_t vichele_management_get_bound_stuff_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t vichele_management_get_bound_stuff_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("vichele_management_get_bound_stuff_args");
...
vichele_management_get_bound_stuff_pargs::~vichele_management_get_bound_stuff_pargs() noexcept {
}


uint32_t vichele_management_get_bound_stuff_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("vichele_management_get_bound_stuff_pargs");
...
vichele_management_get_bound_stuff_result::~vichele_management_get_bound_stuff_result() noexcept {
}


uint32_t vichele_management_get_bound_stuff_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t vichele_management_get_bound_stuff_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("vichele_management_get_bound_stuff_result");
...
vichele_management_get_bound_stuff_presult::~vichele_management_get_bound_stuff_presult() noexcept {
}


uint32_t vichele_management_get_bound_stuff_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void vichele_managementClient::get_bound_stuff(std::string& _return, const std::string& company_name, const std::string& destination_company)
{
  send_get_bound_stuff(company_name, destination_company);
  recv_get_bound_stuff(_return);
}

void vichele_managementClient::send_get_bound_stuff(const std::string& company_name, const std::string& destination_company)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("get_bound_stuff", ::apache::thrift::protocol::T_CALL, cseqid);

  vichele_management_get_bound_stuff_pargs args;
  args.company_name = &company_name;
...
void vichele_managementClient::recv_get_bound_stuff(std::string& _return)
{
  ...
  if (fname.compare("get_bound_stuff") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  vichele_management_get_bound_stuff_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "get_bound_stuff failed: unknown result");
}
...
void vichele_managementProcessor::process_get_bound_stuff(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("vichele_management.get_bound_stuff", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "vichele_management.get_bound_stuff");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "vichele_management.get_bound_stuff");
  }

  vichele_management_get_bound_stuff_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "vichele_management.get_bound_stuff", bytes);
  }

  vichele_management_get_bound_stuff_result result;
  try {
    iface_->get_bound_stuff(result.success, args.company_name, args.destination_company);
    result.__isset.success = true;
  } catch (gen_exp &e) {
    result.e = e;
    result.__isset.e = true;
    ...
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "vichele_management.get_bound_stuff");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("get_bound_stuff", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "vichele_management.get_bound_stuff");
  }

  oprot->writeMessageBegin("get_bound_stuff", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "vichele_management.get_bound_stuff", bytes);
  }
}
...
void vichele_managementConcurrentClient::get_bound_stuff(std::string& _return, const std::string& company_name, const std::string& destination_company)
{
  int32_t seqid = send_get_bound_stuff(company_name, destination_company);
  recv_get_bound_stuff(_return, seqid);
}

int32_t vichele_managementConcurrentClient::send_get_bound_stuff(const std::string& company_name, const std::string& destination_company)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("get_bound_stuff", ::apache::thrift::protocol::T_CALL, cseqid);
...
void vichele_managementConcurrentClient::recv_get_bound_stuff(std::string& _return, const int32_t seqid)
{
