...
vichele_management_get_vichele_in_queue_args::~vichele_management_get_vichele_in_queue_args() noexcept {
}


uint32_t vichele_management_get_vichele_in_queue_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t vichele_management_get_vichele_in_queue_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("vichele_management_get_vichele_in_queue_args");
...
vichele_management_get_vichele_in_queue_pargs::~vichele_management_get_vichele_in_queue_pargs() noexcept {
}


uint32_t vichele_management_get_vichele_in_queue_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("vichele_management_get_vichele_in_queue_pargs");
...
vichele_management_get_vichele_in_queue_result::~vichele_management_get_vichele_in_queue_result() noexcept {
}


uint32_t vichele_management_get_vichele_in_queue_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t vichele_management_get_vichele_in_queue_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("vichele_management_get_vichele_in_queue_result");

  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<vichele_stay_alone> ::const_iterator _iter569;
...
vichele_management_get_vichele_in_queue_presult::~vichele_management_get_vichele_in_queue_presult() noexcept {
}


uint32_t vichele_management_get_vichele_in_queue_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
vichele_management_manual_permit_vichele_args::~vichele_management_manual_permit_vichele_args() noexcept {
}


uint32_t vichele_management_manual_permit_vichele_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t vichele_management_manual_permit_vichele_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("vichele_management_manual_permit_vichele_args");

  xfer += oprot->writeFieldBegin("ssid", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->ssid);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("order_id", ::apache::thrift::protocol::T_I64, 2);
...
vichele_management_manual_permit_vichele_pargs::~vichele_management_manual_permit_vichele_pargs() noexcept {
}


uint32_t vichele_management_manual_permit_vichele_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("vichele_management_manual_permit_vichele_pargs");
...
vichele_management_manual_permit_vichele_result::~vichele_management_manual_permit_vichele_result() noexcept {
}


uint32_t vichele_management_manual_permit_vichele_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t vichele_management_manual_permit_vichele_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("vichele_management_manual_permit_vichele_result");
...
vichele_management_manual_permit_vichele_presult::~vichele_management_manual_permit_vichele_presult() noexcept {
}


uint32_t vichele_management_manual_permit_vichele_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void vichele_managementClient::get_vichele_in_queue(std::vector<vichele_stay_alone> & _return, const std::string& ssid, const std::string& stuff_name)
{
  send_get_vichele_in_queue(ssid, stuff_name);
  recv_get_vichele_in_queue(_return);
}

void vichele_managementClient::send_get_vichele_in_queue(const std::string& ssid, const std::string& stuff_name)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("get_vichele_in_queue", ::apache::thrift::protocol::T_CALL, cseqid);

  vichele_management_get_vichele_in_queue_pargs args;
  args.ssid = &ssid;
  args.stuff_name = &stuff_name;
  args.write(oprot_);
...
void vichele_managementClient::recv_get_vichele_in_queue(std::vector<vichele_stay_alone> & _return)
{
  ...
  if (fname.compare("get_vichele_in_queue") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  vichele_management_get_vichele_in_queue_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "get_vichele_in_queue failed: unknown result");
}

bool vichele_managementClient::manual_permit_vichele(const std::string& ssid, const int64_t order_id)
{
  send_manual_permit_vichele(ssid, order_id);
  return recv_manual_permit_vichele();
}

void vichele_managementClient::send_manual_permit_vichele(const std::string& ssid, const int64_t order_id)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("manual_permit_vichele", ::apache::thrift::protocol::T_CALL, cseqid);

  vichele_management_manual_permit_vichele_pargs args;
  args.ssid = &ssid;
...
bool vichele_managementClient::recv_manual_permit_vichele()
{
  ...
  if (fname.compare("manual_permit_vichele") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  bool _return;
  vichele_management_manual_permit_vichele_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "manual_permit_vichele failed: unknown result");
}
...
void vichele_managementProcessor::process_get_vichele_in_queue(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("vichele_management.get_vichele_in_queue", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "vichele_management.get_vichele_in_queue");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "vichele_management.get_vichele_in_queue");
  }

  vichele_management_get_vichele_in_queue_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "vichele_management.get_vichele_in_queue", bytes);
  }

  vichele_management_get_vichele_in_queue_result result;
  try {
    iface_->get_vichele_in_queue(result.success, args.ssid, args.stuff_name);
    result.__isset.success = true;
  } catch (gen_exp &e) {
    result.e = e;
    result.__isset.e = true;
    ...
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "vichele_management.get_vichele_in_queue");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("get_vichele_in_queue", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "vichele_management.get_vichele_in_queue");
  }

  oprot->writeMessageBegin("get_vichele_in_queue", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "vichele_management.get_vichele_in_queue", bytes);
  }
}

void vichele_managementProcessor::process_manual_permit_vichele(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("vichele_management.manual_permit_vichele", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "vichele_management.manual_permit_vichele");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "vichele_management.manual_permit_vichele");
  }

  vichele_management_manual_permit_vichele_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "vichele_management.manual_permit_vichele", bytes);
  }

  vichele_management_manual_permit_vichele_result result;
  try {
    result.success = iface_->manual_permit_vichele(args.ssid, args.order_id);
    result.__isset.success = true;
  } catch (gen_exp &e) {
    result.e = e;
    result.__isset.e = true;
    ...
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "vichele_management.manual_permit_vichele");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("manual_permit_vichele", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "vichele_management.manual_permit_vichele");
  }

  oprot->writeMessageBegin("manual_permit_vichele", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "vichele_management.manual_permit_vichele", bytes);
  }
}
...
void vichele_managementConcurrentClient::get_vichele_in_queue(std::vector<vichele_stay_alone> & _return, const std::string& ssid, const std::string& stuff_name)
{
  int32_t seqid = send_get_vichele_in_queue(ssid, stuff_name);
  recv_get_vichele_in_queue(_return, seqid);
}

int32_t vichele_managementConcurrentClient::send_get_vichele_in_queue(const std::string& ssid, const std::string& stuff_name)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("get_vichele_in_queue", ::apache::thrift::protocol::T_CALL, cseqid);
...
void vichele_managementConcurrentClient::recv_get_vichele_in_queue(std::vector<vichele_stay_alone> & _return, const int32_t seqid)
{
...
bool vichele_managementConcurrentClient::manual_permit_vichele(const std::string& ssid, const int64_t order_id)
{
  int32_t seqid = send_manual_permit_vichele(ssid, order_id);
  return recv_manual_permit_vichele(seqid);
}

int32_t vichele_managementConcurrentClient::send_manual_permit_vichele(const std::string& ssid, const int64_t order_id)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("manual_permit_vichele", ::apache::thrift::protocol::T_CALL, cseqid);
...
bool vichele_managementConcurrentClient::recv_manual_permit_vichele(const int32_t seqid)
{
