...
deliver_info.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      case 8:
      if (ftype == Thrift.Type.STRING) {
        this.ticket_no = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
push_weight_req.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      case 12:
      if (ftype == Thrift.Type.STRING) {
        this.ticketNo = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
var ticket_detail = module.exports.ticket_detail = function(args) {
  this.ticket_no = null;
...
ticket_detail.prototype = {};
ticket_detail.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      case 8:
      if (ftype == Thrift.Type.STRING) {
        this.p_weight = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      case 9:
      if (ftype == Thrift.Type.STRING) {
        this.m_weight = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
      case 10:
      if (ftype == Thrift.Type.STRING) {
        this.j_weight = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
ticket_detail.prototype.write = function(output) {
...
supplier_basic_info.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.bound_stuff_name = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
