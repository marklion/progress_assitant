    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i147 = 0; _i147 < _size145; ++_i147) {
          var elem148 = null;
          elem148 = new ttypes.vichele_stay_alone();
          elem148.read(input);
          this.vichele_info.push(elem148);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
vichele_management_create_vichele_info_args.prototype.write = function(output) {
  ...
  if (this.vichele_info !== null && this.vichele_info !== undefined) {
    ...
    for (var iter149 in this.vichele_info) {
      if (this.vichele_info.hasOwnProperty(iter149)) {
        iter149 = this.vichele_info[iter149];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i152 = 0; _i152 < _size150; ++_i152) {
          var elem153 = null;
          elem153 = new ttypes.vichele_stay_alone();
          elem153.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i162 = 0; _i162 < _size160; ++_i162) {
          var elem163 = null;
          elem163 = new ttypes.vichele_stay_alone();
          elem163.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i167 = 0; _i167 < _size165; ++_i167) {
          var elem168 = null;
          elem168 = new ttypes.vichele_stay_alone();
          elem168.read(input);
...
vichele_management_cancel_vichele_args.prototype.write = function(output) {
  ...
  if (this.info !== null && this.info !== undefined) {
    output.writeFieldBegin('info', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.info.length);
    for (var iter174 in this.info) {
      if (this.info.hasOwnProperty(iter174)) {
        iter174 = this.info[iter174];
