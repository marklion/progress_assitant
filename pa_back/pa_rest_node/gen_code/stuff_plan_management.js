    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i102 = 0; _i102 < _size100; ++_i102) {
          var elem103 = null;
          elem103 = new ttypes.plan_status();
          elem103.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i107 = 0; _i107 < _size105; ++_i107) {
          var elem108 = null;
          elem108 = new ttypes.deliver_info();
          elem108.read(input);
          this.deliver_infos.push(elem108);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
stuff_plan_management_confirm_deliver_args.prototype.write = function(output) {
  ...
  if (this.deliver_infos !== null && this.deliver_infos !== undefined) {
    ...
    for (var iter109 in this.deliver_infos) {
      if (this.deliver_infos.hasOwnProperty(iter109)) {
        iter109 = this.deliver_infos[iter109];
...
stuff_plan_management_export_plan_args.prototype.write = function(output) {
  ...
  if (this.plan_ids !== null && this.plan_ids !== undefined) {
    ...
    for (var iter114 in this.plan_ids) {
      if (this.plan_ids.hasOwnProperty(iter114)) {
        iter114 = this.plan_ids[iter114];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i117 = 0; _i117 < _size115; ++_i117) {
          var elem118 = null;
          elem118 = new ttypes.plan_number_id();
          elem118.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i122 = 0; _i122 < _size120; ++_i122) {
          var elem123 = null;
          elem123 = new ttypes.plan_status_rule();
          elem123.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i132 = 0; _i132 < _size130; ++_i132) {
          var elem133 = null;
          elem133 = new ttypes.vichele_statistics();
          elem133.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i137 = 0; _i137 < _size135; ++_i137) {
          var elem138 = null;
          elem138 = new ttypes.vichele_search_result();
          elem138.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i142 = 0; _i142 < _size140; ++_i142) {
          var elem143 = null;
          elem143 = new ttypes.vichele_statistics();
          elem143.read(input);
...
stuff_plan_management_cancel_vichele_from_plan_args.prototype.write = function(output) {
  ...
  if (this.ids !== null && this.ids !== undefined) {
    ...
    for (var iter149 in this.ids) {
      if (this.ids.hasOwnProperty(iter149)) {
        iter149 = this.ids[iter149];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i152 = 0; _i152 < _size150; ++_i152) {
          var elem153 = null;
          elem153 = new ttypes.today_driver_info();
          elem153.read(input);
...
stuff_plan_management_multi_confirm_plan_args.prototype.write = function(output) {
  ...
  if (this.plan_ids !== null && this.plan_ids !== undefined) {
    output.writeFieldBegin('plan_ids', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.I64, this.plan_ids.length);
    for (var iter159 in this.plan_ids) {
      if (this.plan_ids.hasOwnProperty(iter159)) {
        iter159 = this.plan_ids[iter159];
