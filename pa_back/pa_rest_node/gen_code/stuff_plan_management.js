    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i102 = 0; _i102 < _size100; ++_i102) {
          var elem103 = null;
          elem103 = new ttypes.deliver_info();
          elem103.read(input);
          this.deliver_infos.push(elem103);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
stuff_plan_management_confirm_deliver_args.prototype.write = function(output) {
  ...
  if (this.deliver_infos !== null && this.deliver_infos !== undefined) {
    ...
    for (var iter104 in this.deliver_infos) {
      if (this.deliver_infos.hasOwnProperty(iter104)) {
        iter104 = this.deliver_infos[iter104];
...
stuff_plan_management_export_plan_args.prototype.write = function(output) {
  ...
  if (this.plan_ids !== null && this.plan_ids !== undefined) {
    ...
    for (var iter109 in this.plan_ids) {
      if (this.plan_ids.hasOwnProperty(iter109)) {
        iter109 = this.plan_ids[iter109];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i112 = 0; _i112 < _size110; ++_i112) {
          var elem113 = null;
          elem113 = new ttypes.plan_number_id();
          elem113.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i117 = 0; _i117 < _size115; ++_i117) {
          var elem118 = null;
          elem118 = new ttypes.plan_status_rule();
          elem118.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i127 = 0; _i127 < _size125; ++_i127) {
          var elem128 = null;
          elem128 = new ttypes.vichele_statistics();
          elem128.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i132 = 0; _i132 < _size130; ++_i132) {
          var elem133 = null;
          elem133 = new ttypes.vichele_search_result();
          elem133.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i137 = 0; _i137 < _size135; ++_i137) {
          var elem138 = null;
          elem138 = new ttypes.vichele_statistics();
          elem138.read(input);
...
stuff_plan_management_cancel_vichele_from_plan_args.prototype.write = function(output) {
  ...
  if (this.ids !== null && this.ids !== undefined) {
    ...
    for (var iter144 in this.ids) {
      if (this.ids.hasOwnProperty(iter144)) {
        iter144 = this.ids[iter144];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i147 = 0; _i147 < _size145; ++_i147) {
          var elem148 = null;
          elem148 = new ttypes.today_driver_info();
          elem148.read(input);
...
stuff_plan_management_multi_confirm_plan_args.prototype.write = function(output) {
  ...
  if (this.plan_ids !== null && this.plan_ids !== undefined) {
    output.writeFieldBegin('plan_ids', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.I64, this.plan_ids.length);
    for (var iter154 in this.plan_ids) {
      if (this.plan_ids.hasOwnProperty(iter154)) {
        iter154 = this.plan_ids[iter154];
