...
class Iface(object):
    ...
    def get_vichele_in_queue(self, ssid, stuff_name):
        """
        Parameters:
         - ssid
         - stuff_name
    ...
    def manual_permit_vichele(self, ssid, order_id):
        """
        Parameters:
         - ssid
         - order_id
...
class Client(Iface):
    ...
    def get_vichele_in_queue(self, ssid, stuff_name):
        ...
        """
        self.send_get_vichele_in_queue(ssid, stuff_name)
        return self.recv_get_vichele_in_queue()

    def send_get_vichele_in_queue(self, ssid, stuff_name):
        self._oprot.writeMessageBegin('get_vichele_in_queue', TMessageType.CALL, self._seqid)
        args = get_vichele_in_queue_args()
        args.ssid = ssid
        args.stuff_name = stuff_name
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_get_vichele_in_queue(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = get_vichele_in_queue_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_vichele_in_queue failed: unknown result")
    ...
    def manual_permit_vichele(self, ssid, order_id):
        ...
        """
        self.send_manual_permit_vichele(ssid, order_id)
        return self.recv_manual_permit_vichele()

    def send_manual_permit_vichele(self, ssid, order_id):
        self._oprot.writeMessageBegin('manual_permit_vichele', TMessageType.CALL, self._seqid)
        args = manual_permit_vichele_args()
        args.ssid = ssid
    ...
    def recv_manual_permit_vichele(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = manual_permit_vichele_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "manual_permit_vichele failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["get_vichele_in_queue"] = Processor.process_get_vichele_in_queue
        self._processMap["manual_permit_vichele"] = Processor.process_manual_permit_vichele
    ...
    def process_get_vichele_in_queue(self, seqid, iprot, oprot):
        args = get_vichele_in_queue_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_vichele_in_queue_result()
        try:
            result.success = self._handler.get_vichele_in_queue(args.ssid, args.stuff_name)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("get_vichele_in_queue", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_manual_permit_vichele(self, seqid, iprot, oprot):
        args = manual_permit_vichele_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = manual_permit_vichele_result()
        try:
            result.success = self._handler.manual_permit_vichele(args.ssid, args.order_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("manual_permit_vichele", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class get_vichele_in_queue_args(object):
    """
    Attributes:
     - ssid
     - stuff_name
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_vichele_in_queue_args')
        if self.ssid is not None:
            oprot.writeFieldBegin('ssid', TType.STRING, 1)
            oprot.writeString(self.ssid.encode('utf-8') if sys.version_info[0] == 2 else self.ssid)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_vichele_in_queue_args)
get_vichele_in_queue_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'stuff_name', 'UTF8', None, ),  # 2
)
...
class get_vichele_in_queue_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_vichele_in_queue_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_vichele_in_queue_result)
get_vichele_in_queue_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [vichele_stay_alone, None], False), None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class manual_permit_vichele_args(object):
    """
    Attributes:
     - ssid
     - order_id
    ...
    def __init__(self, ssid=None, order_id=None,):
        self.ssid = ssid
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('manual_permit_vichele_args')
        if self.ssid is not None:
            oprot.writeFieldBegin('ssid', TType.STRING, 1)
            oprot.writeString(self.ssid.encode('utf-8') if sys.version_info[0] == 2 else self.ssid)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(manual_permit_vichele_args)
manual_permit_vichele_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
...
class manual_permit_vichele_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('manual_permit_vichele_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(manual_permit_vichele_result)
manual_permit_vichele_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)
