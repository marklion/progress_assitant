...
class create_vichele_info_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i186 in range(_size182):
                        ...
                        _elem187.read(iprot)
                        self.vichele_info.append(_elem187)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.vichele_info is not None:
            ...
            for iter188 in self.vichele_info:
                iter188.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
