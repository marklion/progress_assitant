...
class create_vichele_info_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i165 in range(_size161):
                        _elem166 = vichele_stay_alone()
                        _elem166.read(iprot)
                        self.vichele_info.append(_elem166)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.vichele_info is not None:
            ...
            for iter167 in self.vichele_info:
                iter167.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i193 in range(_size189):
                        _elem194 = vichele_stay_alone()
                        _elem194.read(iprot)
                        self.info.append(_elem194)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
