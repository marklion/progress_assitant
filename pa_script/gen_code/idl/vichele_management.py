...
class create_vichele_info_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i207 in range(_size203):
                        ...
                        _elem208.read(iprot)
                        self.vichele_info.append(_elem208)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.vichele_info is not None:
            ...
            for iter209 in self.vichele_info:
                iter209.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i221 in range(_size217):
                        _elem222 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
