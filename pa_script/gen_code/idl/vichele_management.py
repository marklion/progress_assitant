...
class create_vichele_info_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i256 in range(_size252):
                        ...
                        _elem257.read(iprot)
                        self.vichele_info.append(_elem257)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.vichele_info is not None:
            ...
            for iter258 in self.vichele_info:
                iter258.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class confirm_vichele_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i290 in range(_size286):
                        ...
                        self.company_for_select.append(_elem291)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.company_for_select is not None:
            ...
            for iter293 in self.company_for_select:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i298 in range(_size294):
                        _elem299 = vichele_stay_alone()
                        _elem299.read(iprot)
                        self.info.append(_elem299)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
...
class smart_assign_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i326 in range(_size322):
                        _elem327 = vichele_stay_alone()
                        _elem327.read(iprot)
                        self.vichele_info.append(_elem327)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.vichele_info is not None:
            oprot.writeFieldBegin('vichele_info', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.vichele_info))
            for iter328 in self.vichele_info:
                iter328.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i340 in range(_size336):
                        _elem341 = vichele_stay_alone()
                        _elem341.read(iprot)
                        self.info.append(_elem341)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
