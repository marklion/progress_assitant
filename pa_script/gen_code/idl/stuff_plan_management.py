...
class confirm_deliver_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i123 in range(_size119):
                        _elem124 = deliver_info()
                        _elem124.read(iprot)
                        self.deliver_infos.append(_elem124)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.deliver_infos is not None:
            ...
            for iter125 in self.deliver_infos:
                iter125.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i165 in range(_size161):
                        _elem166 = vichele_search_result()
                        _elem166.read(iprot)
