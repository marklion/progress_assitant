...
class confirm_deliver_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i88 in range(_size84):
                        _elem89 = deliver_info()
                        _elem89.read(iprot)
                        self.deliver_infos.append(_elem89)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.deliver_infos is not None:
            ...
            for iter90 in self.deliver_infos:
                iter90.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i130 in range(_size126):
                        _elem131 = vichele_search_result()
                        _elem131.read(iprot)
