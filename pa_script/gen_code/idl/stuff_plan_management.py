...
class confirm_deliver_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i116 in range(_size112):
                        _elem117 = deliver_info()
                        _elem117.read(iprot)
                        self.deliver_infos.append(_elem117)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.deliver_infos is not None:
            ...
            for iter118 in self.deliver_infos:
                iter118.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i158 in range(_size154):
                        _elem159 = vichele_search_result()
                        _elem159.read(iprot)
