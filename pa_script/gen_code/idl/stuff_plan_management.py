...
class confirm_deliver_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i81 in range(_size77):
                        _elem82 = deliver_info()
                        _elem82.read(iprot)
                        self.deliver_infos.append(_elem82)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.deliver_infos is not None:
            ...
            for iter83 in self.deliver_infos:
                iter83.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i123 in range(_size119):
                        _elem124 = vichele_search_result()
                        _elem124.read(iprot)
