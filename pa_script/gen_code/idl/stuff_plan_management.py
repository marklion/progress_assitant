...
class Iface(object):
    ...
    def get_tomorrow_statistics(self, ssid):
        """
        Parameters:
         - ssid
    ...
    def push_user_pay(self, ssid, plan_id):
        """
        Parameters:
         - ssid
         - plan_id
    ...
    def get_count_by_status(self, ssid, status):
        """
        Parameters:
         - ssid
         - status
    ...
    def cancel_vichele_from_plan(self, ssid, ids):
        """
        Parameters:
         - ssid
         - ids
    ...
    def driver_silent_login(self, code):
        """
        Parameters:
         - code
    ...
    def driver_silent_send_sms(self, driver_phone):
        """
        Parameters:
         - driver_phone
    ...
    def driver_silent_register(self, code, driver_id, driver_phone, verify_code):
        """
        Parameters:
         - code
         - driver_id
    ...
    def driver_silent_unregister(self, silent_id):
        """
        Parameters:
         - silent_id
    ...
    def get_today_driver_info(self, silent_id):
        """
        Parameters:
         - silent_id
    ...
    def get_driver_info(self, silent_id):
        """
        Parameters:
         - silent_id
    ...
    def change_driver(self, ssid, vichele_id, driver_name, driver_phone):
        """
        Parameters:
         - ssid
         - vichele_id
    ...
    def change_plan_price(self, ssid, plan_id, new_price):
        """
        Parameters:
         - ssid
         - plan_id
...
class Client(Iface):
    ...
    def get_tomorrow_statistics(self, ssid):
        ...
        """
        self.send_get_tomorrow_statistics(ssid)
        return self.recv_get_tomorrow_statistics()

    def send_get_tomorrow_statistics(self, ssid):
        self._oprot.writeMessageBegin('get_tomorrow_statistics', TMessageType.CALL, self._seqid)
        args = get_tomorrow_statistics_args()
        args.ssid = ssid
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_get_tomorrow_statistics(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = get_tomorrow_statistics_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_tomorrow_statistics failed: unknown result")
    ...
    def push_user_pay(self, ssid, plan_id):
        ...
        """
        self.send_push_user_pay(ssid, plan_id)
        return self.recv_push_user_pay()

    def send_push_user_pay(self, ssid, plan_id):
        self._oprot.writeMessageBegin('push_user_pay', TMessageType.CALL, self._seqid)
        args = push_user_pay_args()
        args.ssid = ssid
        args.plan_id = plan_id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_push_user_pay(self):
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "push_user_pay failed: unknown result")
    ...
    def get_count_by_status(self, ssid, status):
        ...
        """
        self.send_get_count_by_status(ssid, status)
        return self.recv_get_count_by_status()

    def send_get_count_by_status(self, ssid, status):
        self._oprot.writeMessageBegin('get_count_by_status', TMessageType.CALL, self._seqid)
        args = get_count_by_status_args()
        args.ssid = ssid
        args.status = status
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_get_count_by_status(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = get_count_by_status_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_count_by_status failed: unknown result")
    ...
    def cancel_vichele_from_plan(self, ssid, ids):
        ...
        """
        self.send_cancel_vichele_from_plan(ssid, ids)
        return self.recv_cancel_vichele_from_plan()

    def send_cancel_vichele_from_plan(self, ssid, ids):
        self._oprot.writeMessageBegin('cancel_vichele_from_plan', TMessageType.CALL, self._seqid)
        args = cancel_vichele_from_plan_args()
        args.ssid = ssid
        args.ids = ids
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_cancel_vichele_from_plan(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = cancel_vichele_from_plan_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "cancel_vichele_from_plan failed: unknown result")
    ...
    def driver_silent_login(self, code):
        ...
        """
        self.send_driver_silent_login(code)
        return self.recv_driver_silent_login()

    def send_driver_silent_login(self, code):
        self._oprot.writeMessageBegin('driver_silent_login', TMessageType.CALL, self._seqid)
        args = driver_silent_login_args()
        args.code = code
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_driver_silent_login(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = driver_silent_login_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "driver_silent_login failed: unknown result")
    ...
    def driver_silent_send_sms(self, driver_phone):
        ...
        """
        self.send_driver_silent_send_sms(driver_phone)
        return self.recv_driver_silent_send_sms()

    def send_driver_silent_send_sms(self, driver_phone):
        self._oprot.writeMessageBegin('driver_silent_send_sms', TMessageType.CALL, self._seqid)
        args = driver_silent_send_sms_args()
        args.driver_phone = driver_phone
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_driver_silent_send_sms(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = driver_silent_send_sms_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "driver_silent_send_sms failed: unknown result")
    ...
    def driver_silent_register(self, code, driver_id, driver_phone, verify_code):
        ...
        """
        self.send_driver_silent_register(code, driver_id, driver_phone, verify_code)
        return self.recv_driver_silent_register()

    def send_driver_silent_register(self, code, driver_id, driver_phone, verify_code):
        self._oprot.writeMessageBegin('driver_silent_register', TMessageType.CALL, self._seqid)
        args = driver_silent_register_args()
        args.code = code
    ...
    def recv_driver_silent_register(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = driver_silent_register_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "driver_silent_register failed: unknown result")
    ...
    def driver_silent_unregister(self, silent_id):
        ...
        """
        self.send_driver_silent_unregister(silent_id)
        self.recv_driver_silent_unregister()

    def send_driver_silent_unregister(self, silent_id):
        self._oprot.writeMessageBegin('driver_silent_unregister', TMessageType.CALL, self._seqid)
        args = driver_silent_unregister_args()
        args.silent_id = silent_id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_driver_silent_unregister(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = driver_silent_unregister_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.e is not None:
            raise result.e
    ...
    def verify_driver_silent_login(self, silent_id):
        ...
        """
        self.send_verify_driver_silent_login(silent_id)
        return self.recv_verify_driver_silent_login()

    def send_verify_driver_silent_login(self, silent_id):
        self._oprot.writeMessageBegin('verify_driver_silent_login', TMessageType.CALL, self._seqid)
        args = verify_driver_silent_login_args()
        args.silent_id = silent_id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_verify_driver_silent_login(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = verify_driver_silent_login_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "verify_driver_silent_login failed: unknown result")
    ...
    def get_today_driver_info(self, silent_id):
        ...
        """
        self.send_get_today_driver_info(silent_id)
        return self.recv_get_today_driver_info()

    def send_get_today_driver_info(self, silent_id):
        self._oprot.writeMessageBegin('get_today_driver_info', TMessageType.CALL, self._seqid)
        args = get_today_driver_info_args()
        args.silent_id = silent_id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_get_today_driver_info(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = get_today_driver_info_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_today_driver_info failed: unknown result")
    ...
    def get_driver_info(self, silent_id):
        ...
        """
        self.send_get_driver_info(silent_id)
        return self.recv_get_driver_info()

    def send_get_driver_info(self, silent_id):
        self._oprot.writeMessageBegin('get_driver_info', TMessageType.CALL, self._seqid)
        args = get_driver_info_args()
        args.silent_id = silent_id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_get_driver_info(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
    ...
    def change_driver(self, ssid, vichele_id, driver_name, driver_phone):
        ...
        """
        self.send_change_driver(ssid, vichele_id, driver_name, driver_phone)
        return self.recv_change_driver()

    def send_change_driver(self, ssid, vichele_id, driver_name, driver_phone):
        self._oprot.writeMessageBegin('change_driver', TMessageType.CALL, self._seqid)
        args = change_driver_args()
        args.ssid = ssid
        args.vichele_id = vichele_id
    ...
    def recv_change_driver(self):
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "change_driver failed: unknown result")
    ...
    def change_plan_price(self, ssid, plan_id, new_price):
        ...
        """
        self.send_change_plan_price(ssid, plan_id, new_price)
        return self.recv_change_plan_price()

    def send_change_plan_price(self, ssid, plan_id, new_price):
        self._oprot.writeMessageBegin('change_plan_price', TMessageType.CALL, self._seqid)
        args = change_plan_price_args()
        args.ssid = ssid
        args.plan_id = plan_id
    ...
    def recv_change_plan_price(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = change_plan_price_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "change_plan_price failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["get_tomorrow_statistics"] = Processor.process_get_tomorrow_statistics
        self._processMap["get_company_brief"] = Processor.process_get_company_brief
        self._processMap["push_user_pay"] = Processor.process_push_user_pay
        self._processMap["get_count_by_status"] = Processor.process_get_count_by_status
        self._processMap["cancel_vichele_from_plan"] = Processor.process_cancel_vichele_from_plan
        self._processMap["driver_silent_login"] = Processor.process_driver_silent_login
        ...
        self._processMap["change_driver"] = Processor.process_change_driver
        self._processMap["change_plan_price"] = Processor.process_change_plan_price
    ...
    def process_get_tomorrow_statistics(self, seqid, iprot, oprot):
        args = get_tomorrow_statistics_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_tomorrow_statistics_result()
        try:
            result.success = self._handler.get_tomorrow_statistics(args.ssid)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("get_tomorrow_statistics", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_push_user_pay(self, seqid, iprot, oprot):
        args = push_user_pay_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = push_user_pay_result()
        try:
            result.success = self._handler.push_user_pay(args.ssid, args.plan_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("push_user_pay", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_get_count_by_status(self, seqid, iprot, oprot):
        args = get_count_by_status_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_count_by_status_result()
        try:
            result.success = self._handler.get_count_by_status(args.ssid, args.status)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("get_count_by_status", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_cancel_vichele_from_plan(self, seqid, iprot, oprot):
        args = cancel_vichele_from_plan_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = cancel_vichele_from_plan_result()
        try:
            result.success = self._handler.cancel_vichele_from_plan(args.ssid, args.ids)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("cancel_vichele_from_plan", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_driver_silent_login(self, seqid, iprot, oprot):
        args = driver_silent_login_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = driver_silent_login_result()
        try:
            result.success = self._handler.driver_silent_login(args.code)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("driver_silent_login", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_driver_silent_send_sms(self, seqid, iprot, oprot):
        args = driver_silent_send_sms_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = driver_silent_send_sms_result()
        try:
            result.success = self._handler.driver_silent_send_sms(args.driver_phone)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("driver_silent_send_sms", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_driver_silent_register(self, seqid, iprot, oprot):
        args = driver_silent_register_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = driver_silent_register_result()
        try:
            result.success = self._handler.driver_silent_register(args.code, args.driver_id, args.driver_phone, args.verify_code)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("driver_silent_register", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_driver_silent_unregister(self, seqid, iprot, oprot):
        args = driver_silent_unregister_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = driver_silent_unregister_result()
        try:
            self._handler.driver_silent_unregister(args.silent_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
    ...
    def process_verify_driver_silent_login(self, seqid, iprot, oprot):
        args = verify_driver_silent_login_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = verify_driver_silent_login_result()
        try:
            result.success = self._handler.verify_driver_silent_login(args.silent_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("verify_driver_silent_login", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_get_today_driver_info(self, seqid, iprot, oprot):
        args = get_today_driver_info_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_today_driver_info_result()
        try:
            result.success = self._handler.get_today_driver_info(args.silent_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("get_today_driver_info", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_get_driver_info(self, seqid, iprot, oprot):
        args = get_driver_info_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_driver_info_result()
        try:
            result.success = self._handler.get_driver_info(args.silent_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
    ...
    def process_change_driver(self, seqid, iprot, oprot):
        args = change_driver_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = change_driver_result()
        try:
            result.success = self._handler.change_driver(args.ssid, args.vichele_id, args.driver_name, args.driver_phone)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("change_driver", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_change_plan_price(self, seqid, iprot, oprot):
        args = change_plan_price_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = change_plan_price_result()
        try:
            result.success = self._handler.change_plan_price(args.ssid, args.plan_id, args.new_price)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("change_plan_price", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class get_tomorrow_statistics_args(object):
    """
    Attributes:
     - ssid
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_tomorrow_statistics_args')
        if self.ssid is not None:
            oprot.writeFieldBegin('ssid', TType.STRING, 1)
            oprot.writeString(self.ssid.encode('utf-8') if sys.version_info[0] == 2 else self.ssid)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_tomorrow_statistics_args)
get_tomorrow_statistics_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
)


class get_tomorrow_statistics_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_tomorrow_statistics_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_tomorrow_statistics_result)
get_tomorrow_statistics_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [vichele_statistics, None], False), None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)
...
class get_company_brief_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = company_plan_brief()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
get_company_brief_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [company_plan_brief, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class push_user_pay_args(object):
    """
    Attributes:
     - ssid
     - plan_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('push_user_pay_args')
        if self.ssid is not None:
            oprot.writeFieldBegin('ssid', TType.STRING, 1)
            oprot.writeString(self.ssid.encode('utf-8') if sys.version_info[0] == 2 else self.ssid)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(push_user_pay_args)
push_user_pay_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
    (2, TType.I64, 'plan_id', None, None, ),  # 2
)
...
class push_user_pay_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('push_user_pay_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(push_user_pay_result)
push_user_pay_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class get_count_by_status_args(object):
    """
    Attributes:
     - ssid
     - status
    ...
    def __init__(self, ssid=None, status=None,):
        self.ssid = ssid
        self.status = status
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_count_by_status_args')
        if self.ssid is not None:
            oprot.writeFieldBegin('ssid', TType.STRING, 1)
            oprot.writeString(self.ssid.encode('utf-8') if sys.version_info[0] == 2 else self.ssid)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_count_by_status_args)
get_count_by_status_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
...
class get_count_by_status_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_count_by_status_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I64, 0)
            oprot.writeI64(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_count_by_status_result)
get_count_by_status_result.thrift_spec = (
    (0, TType.I64, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class cancel_vichele_from_plan_args(object):
    """
    Attributes:
     - ssid
     - ids
    ...
    def __init__(self, ssid=None, ids=None,):
        self.ssid = ssid
        self.ids = ids
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('cancel_vichele_from_plan_args')
        if self.ssid is not None:
            oprot.writeFieldBegin('ssid', TType.STRING, 1)
            oprot.writeString(self.ssid.encode('utf-8') if sys.version_info[0] == 2 else self.ssid)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(cancel_vichele_from_plan_args)
cancel_vichele_from_plan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
...
class cancel_vichele_from_plan_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('cancel_vichele_from_plan_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(cancel_vichele_from_plan_result)
cancel_vichele_from_plan_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class driver_silent_login_args(object):
    """
    Attributes:
     - code
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('driver_silent_login_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(driver_silent_login_args)
driver_silent_login_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'code', 'UTF8', None, ),  # 1
)


class driver_silent_login_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('driver_silent_login_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRING, 0)
            oprot.writeString(self.success.encode('utf-8') if sys.version_info[0] == 2 else self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(driver_silent_login_result)
driver_silent_login_result.thrift_spec = (
    (0, TType.STRING, 'success', 'UTF8', None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class driver_silent_send_sms_args(object):
    """
    Attributes:
     - driver_phone
    ...
    def __init__(self, driver_phone=None,):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('driver_silent_send_sms_args')
        if self.driver_phone is not None:
            oprot.writeFieldBegin('driver_phone', TType.STRING, 1)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(driver_silent_send_sms_args)
driver_silent_send_sms_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'driver_phone', 'UTF8', None, ),  # 1
)


class driver_silent_send_sms_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('driver_silent_send_sms_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(driver_silent_send_sms_result)
driver_silent_send_sms_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class driver_silent_register_args(object):
    """
    Attributes:
     - code
     - driver_id
    ...
    def __init__(self, code=None, driver_id=None, driver_phone=None, verify_code=None,):
        self.code = code
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('driver_silent_register_args')
        if self.code is not None:
            oprot.writeFieldBegin('code', TType.STRING, 1)
            oprot.writeString(self.code.encode('utf-8') if sys.version_info[0] == 2 else self.code)
            oprot.writeFieldEnd()
        if self.driver_id is not None:
            oprot.writeFieldBegin('driver_id', TType.STRING, 2)
            oprot.writeString(self.driver_id.encode('utf-8') if sys.version_info[0] == 2 else self.driver_id)
            oprot.writeFieldEnd()
        if self.driver_phone is not None:
            oprot.writeFieldBegin('driver_phone', TType.STRING, 3)
            oprot.writeString(self.driver_phone.encode('utf-8') if sys.version_info[0] == 2 else self.driver_phone)
            oprot.writeFieldEnd()
        if self.verify_code is not None:
            oprot.writeFieldBegin('verify_code', TType.STRING, 4)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(driver_silent_register_args)
driver_silent_register_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'code', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'driver_id', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'driver_phone', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'verify_code', 'UTF8', None, ),  # 4
)


class driver_silent_register_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('driver_silent_register_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRING, 0)
            oprot.writeString(self.success.encode('utf-8') if sys.version_info[0] == 2 else self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(driver_silent_register_result)
driver_silent_register_result.thrift_spec = (
    (0, TType.STRING, 'success', 'UTF8', None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class driver_silent_unregister_args(object):
    """
    Attributes:
     - silent_id
    ...
    def __init__(self, silent_id=None,):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('driver_silent_unregister_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(driver_silent_unregister_args)
driver_silent_unregister_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'silent_id', 'UTF8', None, ),  # 1
)


class driver_silent_unregister_result(object):
    """
    Attributes:
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('driver_silent_unregister_result')
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            self.e.write(oprot)
            oprot.writeFieldEnd()
...
class verify_driver_silent_login_args(object):
    """
    Attributes:
     - silent_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('verify_driver_silent_login_args')
        if self.silent_id is not None:
            oprot.writeFieldBegin('silent_id', TType.STRING, 1)
            oprot.writeString(self.silent_id.encode('utf-8') if sys.version_info[0] == 2 else self.silent_id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(verify_driver_silent_login_args)
verify_driver_silent_login_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'silent_id', 'UTF8', None, ),  # 1
)


class verify_driver_silent_login_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('verify_driver_silent_login_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(verify_driver_silent_login_result)
verify_driver_silent_login_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class get_today_driver_info_args(object):
    """
    Attributes:
     - silent_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_today_driver_info_args')
        if self.silent_id is not None:
            oprot.writeFieldBegin('silent_id', TType.STRING, 1)
            oprot.writeString(self.silent_id.encode('utf-8') if sys.version_info[0] == 2 else self.silent_id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_today_driver_info_args)
get_today_driver_info_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'silent_id', 'UTF8', None, ),  # 1
)


class get_today_driver_info_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_today_driver_info_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_today_driver_info_result)
get_today_driver_info_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [today_driver_info, None], False), None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class get_driver_info_args(object):
    """
    Attributes:
     - silent_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_driver_info_args')
        if self.silent_id is not None:
            oprot.writeFieldBegin('silent_id', TType.STRING, 1)
            oprot.writeString(self.silent_id.encode('utf-8') if sys.version_info[0] == 2 else self.silent_id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_driver_info_args)
get_driver_info_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'silent_id', 'UTF8', None, ),  # 1
)


class get_driver_info_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = driver_detail_info()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_driver_info_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
...
class change_driver_args(object):
    """
    Attributes:
     - ssid
     - vichele_id
    ...
    def __init__(self, ssid=None, vichele_id=None, driver_name=None, driver_phone=None,):
        self.ssid = ssid
        self.vichele_id = vichele_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('change_driver_args')
        if self.ssid is not None:
            oprot.writeFieldBegin('ssid', TType.STRING, 1)
            oprot.writeString(self.ssid.encode('utf-8') if sys.version_info[0] == 2 else self.ssid)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(change_driver_args)
change_driver_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
    (2, TType.I64, 'vichele_id', None, None, ),  # 2
...
class change_driver_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('change_driver_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(change_driver_result)
change_driver_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class change_plan_price_args(object):
    """
    Attributes:
     - ssid
     - plan_id
    ...
    def __init__(self, ssid=None, plan_id=None, new_price=None,):
        self.ssid = ssid
        self.plan_id = plan_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('change_plan_price_args')
        if self.ssid is not None:
            oprot.writeFieldBegin('ssid', TType.STRING, 1)
            oprot.writeString(self.ssid.encode('utf-8') if sys.version_info[0] == 2 else self.ssid)
            oprot.writeFieldEnd()
        ...
        if self.new_price is not None:
            oprot.writeFieldBegin('new_price', TType.DOUBLE, 3)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(change_plan_price_args)
change_plan_price_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'plan_id', (TType.I64, None, False), None, ),  # 2
    (3, TType.DOUBLE, 'new_price', None, None, ),  # 3
)


class change_plan_price_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('change_plan_price_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(change_plan_price_result)
change_plan_price_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)
