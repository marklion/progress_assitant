...
class confirm_deliver_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i130 in range(_size126):
                        _elem131 = deliver_info()
                        _elem131.read(iprot)
                        self.deliver_infos.append(_elem131)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.deliver_infos is not None:
            ...
            for iter132 in self.deliver_infos:
                iter132.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i172 in range(_size168):
                        _elem173 = vichele_search_result()
                        _elem173.read(iprot)
