...
class Iface(object):
    ...
    def push_exit_count(self, id, count, is_sale, token):
        """
        Parameters:
         - id
         - count
    ...
    def push_arrange(self, id, order, is_sale, location, token):
        """
        Parameters:
         - id
         - order
...
class Client(Iface):
    ...
    def push_exit_count(self, id, count, is_sale, token):
        ...
        """
        self.send_push_exit_count(id, count, is_sale, token)
        return self.recv_push_exit_count()

    def send_push_exit_count(self, id, count, is_sale, token):
        self._oprot.writeMessageBegin('push_exit_count', TMessageType.CALL, self._seqid)
        args = push_exit_count_args()
        args.id = id
        args.count = count
    ...
    def recv_push_exit_count(self):
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "push_exit_count failed: unknown result")
    ...
    def push_arrange(self, id, order, is_sale, location, token):
        ...
        """
        self.send_push_arrange(id, order, is_sale, location, token)
        return self.recv_push_arrange()

    def send_push_arrange(self, id, order, is_sale, location, token):
        self._oprot.writeMessageBegin('push_arrange', TMessageType.CALL, self._seqid)
        args = push_arrange_args()
        args.id = id
        args.order = order
        args.is_sale = is_sale
    ...
    def recv_push_arrange(self):
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "push_arrange failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["push_exit_count"] = Processor.process_push_exit_count
        self._processMap["push_arrange"] = Processor.process_push_arrange
    ...
    def process_push_exit_count(self, seqid, iprot, oprot):
        args = push_exit_count_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = push_exit_count_result()
        try:
            result.success = self._handler.push_exit_count(args.id, args.count, args.is_sale, args.token)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("push_exit_count", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_push_arrange(self, seqid, iprot, oprot):
        args = push_arrange_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = push_arrange_result()
        try:
            result.success = self._handler.push_arrange(args.id, args.order, args.is_sale, args.location, args.token)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("push_arrange", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i207 in range(_size203):
                        _elem208 = api_transformation_info()
                        _elem208.read(iprot)
...
class push_exit_count_args(object):
    """
    Attributes:
     - id
     - count
    ...
    def __init__(self, id=None, count=None, is_sale=None, token=None,):
        self.id = id
        self.count = count
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('push_exit_count_args')
        ...
        if self.is_sale is not None:
            oprot.writeFieldBegin('is_sale', TType.BOOL, 3)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(push_exit_count_args)
push_exit_count_args.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'id', None, None, ),  # 1
    (2, TType.DOUBLE, 'count', None, None, ),  # 2
    (3, TType.BOOL, 'is_sale', None, None, ),  # 3
    (4, TType.STRING, 'token', 'UTF8', None, ),  # 4
)


class push_exit_count_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('push_exit_count_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(push_exit_count_result)
push_exit_count_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)


class push_arrange_args(object):
    """
    Attributes:
     - id
     - order
    ...
    def __init__(self, id=None, order=None, is_sale=None, location=None, token=None,):
        self.id = id
        self.order = order
        self.is_sale = is_sale
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('push_arrange_args')
        if self.id is not None:
            oprot.writeFieldBegin('id', TType.I64, 1)
            oprot.writeI64(self.id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(push_arrange_args)
push_arrange_args.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'id', None, None, ),  # 1
...
class push_arrange_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('push_arrange_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(push_arrange_result)
push_arrange_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)
