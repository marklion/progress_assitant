...
class Iface(object):
    ...
    def modify_vehicle_info_from_ticket(self, ssid, ticket):
        """
        Parameters:
         - ssid
         - ticket
...
class Client(Iface):
    ...
    def modify_vehicle_info_from_ticket(self, ssid, ticket):
        ...
        """
        self.send_modify_vehicle_info_from_ticket(ssid, ticket)
        return self.recv_modify_vehicle_info_from_ticket()

    def send_modify_vehicle_info_from_ticket(self, ssid, ticket):
        self._oprot.writeMessageBegin('modify_vehicle_info_from_ticket', TMessageType.CALL, self._seqid)
        args = modify_vehicle_info_from_ticket_args()
        args.ssid = ssid
        args.ticket = ticket
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_modify_vehicle_info_from_ticket(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = modify_vehicle_info_from_ticket_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "modify_vehicle_info_from_ticket failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["modify_vehicle_info_from_ticket"] = Processor.process_modify_vehicle_info_from_ticket
    ...
    def process_modify_vehicle_info_from_ticket(self, seqid, iprot, oprot):
        args = modify_vehicle_info_from_ticket_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = modify_vehicle_info_from_ticket_result()
        try:
            result.success = self._handler.modify_vehicle_info_from_ticket(args.ssid, args.ticket)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except gen_exp as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("modify_vehicle_info_from_ticket", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class modify_vehicle_info_from_ticket_args(object):
    """
    Attributes:
     - ssid
     - ticket
    ...
    def __init__(self, ssid=None, ticket=None,):
        self.ssid = ssid
        self.ticket = ticket
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('modify_vehicle_info_from_ticket_args')
        ...
        if self.ticket is not None:
            oprot.writeFieldBegin('ticket', TType.STRUCT, 2)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(modify_vehicle_info_from_ticket_args)
modify_vehicle_info_from_ticket_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ssid', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'ticket', [ticket_detail, None], None, ),  # 2
)


class modify_vehicle_info_from_ticket_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('modify_vehicle_info_from_ticket_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(modify_vehicle_info_from_ticket_result)
modify_vehicle_info_from_ticket_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'e', [gen_exp, None], None, ),  # 1
)
