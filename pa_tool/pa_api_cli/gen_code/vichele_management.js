...
var vichele_management_get_bound_stuff_args = function(args) {
  this.company_name = null;
...
vichele_management_get_bound_stuff_args.prototype = {};
vichele_management_get_bound_stuff_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
vichele_management_get_bound_stuff_args.prototype.write = function(output) {
  output.writeStructBegin('vichele_management_get_bound_stuff_args');
  if (this.company_name !== null && this.company_name !== undefined) {
...
var vichele_management_get_bound_stuff_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof ttypes.gen_exp) {
    this.e = args;
...
vichele_management_get_bound_stuff_result.prototype = {};
vichele_management_get_bound_stuff_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
vichele_management_get_bound_stuff_result.prototype.write = function(output) {
  output.writeStructBegin('vichele_management_get_bound_stuff_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRING, 0);
    output.writeString(this.success);
    output.writeFieldEnd();
...
vichele_managementClient.prototype.get_bound_stuff = function(company_name, destination_company, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_get_bound_stuff(company_name, destination_company);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_get_bound_stuff(company_name, destination_company);
...
vichele_managementClient.prototype.send_get_bound_stuff = function(company_name, destination_company) {
  var output = new this.pClass(this.output);
  var params = {
    company_name: company_name,
    destination_company: destination_company
  };
  var args = new vichele_management_get_bound_stuff_args(params);
  try {
    output.writeMessageBegin('get_bound_stuff', Thrift.MessageType.CALL, this.seqid());
    args.write(output);
    output.writeMessageEnd();
    return this.output.flush();
  }
...
vichele_managementClient.prototype.recv_get_bound_stuff = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new vichele_management_get_bound_stuff_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('get_bound_stuff failed: unknown result');
};
...
vichele_managementProcessor.prototype.process_get_bound_stuff = function(seqid, input, output) {
  var args = new vichele_management_get_bound_stuff_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.get_bound_stuff.length === 2) {
    Q.fcall(this._handler.get_bound_stuff.bind(this._handler),
      args.company_name,
      args.destination_company
    ).then(function(result) {
      var result_obj = new vichele_management_get_bound_stuff_result({success: result});
      output.writeMessageBegin("get_bound_stuff", Thrift.MessageType.REPLY, seqid);
      result_obj.write(output);
      output.writeMessageEnd();
      output.flush();
    }).catch(function (err) {
      var result;
      if (err instanceof ttypes.gen_exp) {
        result = new vichele_management_get_bound_stuff_result(err);
        output.writeMessageBegin("get_bound_stuff", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("get_bound_stuff", Thrift.MessageType.EXCEPTION, seqid);
      }
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    ...
    this._handler.get_bound_stuff(args.company_name, args.destination_company, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof ttypes.gen_exp) {
        result_obj = new vichele_management_get_bound_stuff_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("get_bound_stuff", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("get_bound_stuff", Thrift.MessageType.EXCEPTION, seqid);
