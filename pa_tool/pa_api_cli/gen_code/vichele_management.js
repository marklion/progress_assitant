...
vichele_management_create_vichele_info_args.prototype.write = function(output) {
  ...
  if (this.vichele_info !== null && this.vichele_info !== undefined) {
    ...
    for (var iter189 in this.vichele_info) {
...
vichele_management_confirm_vichele_args.prototype.write = function(output) {
  ...
  if (this.company_for_select !== null && this.company_for_select !== undefined) {
    ...
    for (var iter214 in this.company_for_select) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i217 = 0; _i217 < _size215; ++_i217) {
          var elem218 = null;
          elem218 = new ttypes.vichele_stay_alone();
          elem218.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i222 = 0; _i222 < _size220; ++_i222) {
          var elem223 = null;
          elem223 = new ttypes.vichele_team();
          elem223.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i232 = 0; _i232 < _size230; ++_i232) {
          var elem233 = null;
          elem233 = new ttypes.supplier_basic_info();
          elem233.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i237 = 0; _i237 < _size235; ++_i237) {
          var elem238 = null;
          elem238 = new ttypes.vichele_stay_alone();
          elem238.read(input);
...
vichele_management_smart_assign_args.prototype.write = function(output) {
  ...
  if (this.vichele_info !== null && this.vichele_info !== undefined) {
    output.writeFieldBegin('vichele_info', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.vichele_info.length);
    for (var iter239 in this.vichele_info) {
...
var vichele_management_change_price_args = function(args) {
  this.ssid = null;
  this.info = null;
  this.all_select = null;
  this.enter_date = null;
...
vichele_management_change_price_args.prototype = {};
vichele_management_change_price_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i247 = 0; _i247 < _size245; ++_i247) {
          var elem248 = null;
          elem248 = new ttypes.vichele_stay_alone();
          elem248.read(input);
...
vichele_management_change_price_args.prototype.write = function(output) {
...
var vichele_management_change_price_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof ttypes.gen_exp) {
    this.e = args;
...
vichele_management_change_price_result.prototype = {};
vichele_management_change_price_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
vichele_management_change_price_result.prototype.write = function(output) {
...
var vichele_management_get_vichele_in_queue_args = function(args) {
  this.ssid = null;
  this.stuff_name = null;
  if (args) {
    if (args.ssid !== undefined && args.ssid !== null) {
...
vichele_management_get_vichele_in_queue_args.prototype = {};
vichele_management_get_vichele_in_queue_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
vichele_management_get_vichele_in_queue_args.prototype.write = function(output) {
  output.writeStructBegin('vichele_management_get_vichele_in_queue_args');
  if (this.ssid !== null && this.ssid !== undefined) {
    output.writeFieldBegin('ssid', Thrift.Type.STRING, 1);
    output.writeString(this.ssid);
    output.writeFieldEnd();
...
var vichele_management_get_vichele_in_queue_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof ttypes.gen_exp) {
    this.e = args;
...
vichele_management_get_vichele_in_queue_result.prototype = {};
vichele_management_get_vichele_in_queue_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i252 = 0; _i252 < _size250; ++_i252) {
          var elem253 = null;
          elem253 = new ttypes.vichele_stay_alone();
          elem253.read(input);
...
vichele_management_get_vichele_in_queue_result.prototype.write = function(output) {
  output.writeStructBegin('vichele_management_get_vichele_in_queue_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0);
    output.writeListBegin(Thrift.Type.STRUCT, this.success.length);
...
var vichele_management_manual_permit_vichele_args = function(args) {
  this.ssid = null;
  this.order_id = null;
  if (args) {
    if (args.ssid !== undefined && args.ssid !== null) {
...
vichele_management_manual_permit_vichele_args.prototype = {};
vichele_management_manual_permit_vichele_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
vichele_management_manual_permit_vichele_args.prototype.write = function(output) {
  output.writeStructBegin('vichele_management_manual_permit_vichele_args');
  if (this.ssid !== null && this.ssid !== undefined) {
    output.writeFieldBegin('ssid', Thrift.Type.STRING, 1);
    output.writeString(this.ssid);
    output.writeFieldEnd();
  ...
  if (this.order_id !== null && this.order_id !== undefined) {
    output.writeFieldBegin('order_id', Thrift.Type.I64, 2);
    output.writeI64(this.order_id);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
var vichele_management_manual_permit_vichele_result = function(args) {
  this.success = null;
  this.e = null;
  if (args instanceof ttypes.gen_exp) {
    this.e = args;
...
vichele_management_manual_permit_vichele_result.prototype = {};
vichele_management_manual_permit_vichele_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
vichele_management_manual_permit_vichele_result.prototype.write = function(output) {
  output.writeStructBegin('vichele_management_manual_permit_vichele_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.BOOL, 0);
    output.writeBool(this.success);
    output.writeFieldEnd();
...
vichele_managementClient.prototype.confirm_vichele = function(ssid, info, company_for_select, all_select, enter_date, stuff_name, supplier_name, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_confirm_vichele(ssid, info, company_for_select, all_select, enter_date, stuff_name, supplier_name);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_confirm_vichele(ssid, info, company_for_select, all_select, enter_date, stuff_name, supplier_name);
...
vichele_managementClient.prototype.send_confirm_vichele = function(ssid, info, company_for_select, all_select, enter_date, stuff_name, supplier_name) {
  var output = new this.pClass(this.output);
  var params = {
    ssid: ssid,
    info: info,
...
vichele_managementClient.prototype.cancel_vichele = function(ssid, info, all_select, enter_date, stuff_name, supplier_name, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_cancel_vichele(ssid, info, all_select, enter_date, stuff_name, supplier_name);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_cancel_vichele(ssid, info, all_select, enter_date, stuff_name, supplier_name);
...
vichele_managementClient.prototype.send_cancel_vichele = function(ssid, info, all_select, enter_date, stuff_name, supplier_name) {
  var output = new this.pClass(this.output);
  var params = {
    ssid: ssid,
    info: info,
...
vichele_managementClient.prototype.change_price = function(ssid, info, all_select, enter_date, stuff_name, supplier_name, new_price, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_change_price(ssid, info, all_select, enter_date, stuff_name, supplier_name, new_price);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_change_price(ssid, info, all_select, enter_date, stuff_name, supplier_name, new_price);
...
vichele_managementClient.prototype.send_change_price = function(ssid, info, all_select, enter_date, stuff_name, supplier_name, new_price) {
  var output = new this.pClass(this.output);
  var params = {
    ssid: ssid,
    info: info,
  ...
  var args = new vichele_management_change_price_args(params);
  try {
    output.writeMessageBegin('change_price', Thrift.MessageType.CALL, this.seqid());
    args.write(output);
    output.writeMessageEnd();
    return this.output.flush();
  }
...
vichele_managementClient.prototype.recv_change_price = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new vichele_management_change_price_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('change_price failed: unknown result');
};

vichele_managementClient.prototype.get_vichele_in_queue = function(ssid, stuff_name, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_get_vichele_in_queue(ssid, stuff_name);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_get_vichele_in_queue(ssid, stuff_name);
...
vichele_managementClient.prototype.send_get_vichele_in_queue = function(ssid, stuff_name) {
  var output = new this.pClass(this.output);
  var params = {
    ssid: ssid,
    stuff_name: stuff_name
  };
  var args = new vichele_management_get_vichele_in_queue_args(params);
  try {
    output.writeMessageBegin('get_vichele_in_queue', Thrift.MessageType.CALL, this.seqid());
    args.write(output);
    output.writeMessageEnd();
    return this.output.flush();
  }
...
vichele_managementClient.prototype.recv_get_vichele_in_queue = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new vichele_management_get_vichele_in_queue_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('get_vichele_in_queue failed: unknown result');
};

vichele_managementClient.prototype.manual_permit_vichele = function(ssid, order_id, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
    ...
    this.send_manual_permit_vichele(ssid, order_id);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_manual_permit_vichele(ssid, order_id);
...
vichele_managementClient.prototype.send_manual_permit_vichele = function(ssid, order_id) {
  var output = new this.pClass(this.output);
  var params = {
    ssid: ssid,
    order_id: order_id
  };
  var args = new vichele_management_manual_permit_vichele_args(params);
  try {
    output.writeMessageBegin('manual_permit_vichele', Thrift.MessageType.CALL, this.seqid());
    args.write(output);
    output.writeMessageEnd();
    return this.output.flush();
  }
...
vichele_managementClient.prototype.recv_manual_permit_vichele = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new vichele_management_manual_permit_vichele_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('manual_permit_vichele failed: unknown result');
};
...
vichele_managementProcessor.prototype.process_confirm_vichele = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.confirm_vichele.length === 7) {
    ...
    this._handler.confirm_vichele(args.ssid, args.info, args.company_for_select, args.all_select, args.enter_date, args.stuff_name, args.supplier_name, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof ttypes.gen_exp) {
...
vichele_managementProcessor.prototype.process_cancel_vichele = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.cancel_vichele.length === 6) {
    ...
    this._handler.cancel_vichele(args.ssid, args.info, args.all_select, args.enter_date, args.stuff_name, args.supplier_name, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof ttypes.gen_exp) {
...
vichele_managementProcessor.prototype.process_change_price = function(seqid, input, output) {
  var args = new vichele_management_change_price_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.change_price.length === 7) {
    Q.fcall(this._handler.change_price.bind(this._handler),
      args.ssid,
      args.info,
      args.all_select,
      args.enter_date,
      ...
      var result_obj = new vichele_management_change_price_result({success: result});
      output.writeMessageBegin("change_price", Thrift.MessageType.REPLY, seqid);
      result_obj.write(output);
      output.writeMessageEnd();
      output.flush();
    }).catch(function (err) {
      var result;
      if (err instanceof ttypes.gen_exp) {
        result = new vichele_management_change_price_result(err);
        output.writeMessageBegin("change_price", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("change_price", Thrift.MessageType.EXCEPTION, seqid);
      }
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    ...
    this._handler.change_price(args.ssid, args.info, args.all_select, args.enter_date, args.stuff_name, args.supplier_name, args.new_price, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof ttypes.gen_exp) {
        result_obj = new vichele_management_change_price_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("change_price", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("change_price", Thrift.MessageType.EXCEPTION, seqid);
...
vichele_managementProcessor.prototype.process_get_vichele_in_queue = function(seqid, input, output) {
  var args = new vichele_management_get_vichele_in_queue_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.get_vichele_in_queue.length === 2) {
    Q.fcall(this._handler.get_vichele_in_queue.bind(this._handler),
      args.ssid,
      args.stuff_name
    ).then(function(result) {
      var result_obj = new vichele_management_get_vichele_in_queue_result({success: result});
      output.writeMessageBegin("get_vichele_in_queue", Thrift.MessageType.REPLY, seqid);
      result_obj.write(output);
      output.writeMessageEnd();
      output.flush();
    }).catch(function (err) {
      var result;
      if (err instanceof ttypes.gen_exp) {
        result = new vichele_management_get_vichele_in_queue_result(err);
        output.writeMessageBegin("get_vichele_in_queue", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("get_vichele_in_queue", Thrift.MessageType.EXCEPTION, seqid);
      }
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    ...
    this._handler.get_vichele_in_queue(args.ssid, args.stuff_name, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof ttypes.gen_exp) {
        result_obj = new vichele_management_get_vichele_in_queue_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("get_vichele_in_queue", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("get_vichele_in_queue", Thrift.MessageType.EXCEPTION, seqid);
...
vichele_managementProcessor.prototype.process_manual_permit_vichele = function(seqid, input, output) {
  var args = new vichele_management_manual_permit_vichele_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.manual_permit_vichele.length === 2) {
    Q.fcall(this._handler.manual_permit_vichele.bind(this._handler),
      args.ssid,
      args.order_id
    ).then(function(result) {
      var result_obj = new vichele_management_manual_permit_vichele_result({success: result});
      output.writeMessageBegin("manual_permit_vichele", Thrift.MessageType.REPLY, seqid);
      result_obj.write(output);
      output.writeMessageEnd();
      output.flush();
    }).catch(function (err) {
      var result;
      if (err instanceof ttypes.gen_exp) {
        result = new vichele_management_manual_permit_vichele_result(err);
        output.writeMessageBegin("manual_permit_vichele", Thrift.MessageType.REPLY, seqid);
      } else {
        result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("manual_permit_vichele", Thrift.MessageType.EXCEPTION, seqid);
      }
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    ...
    this._handler.manual_permit_vichele(args.ssid, args.order_id, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof ttypes.gen_exp) {
        result_obj = new vichele_management_manual_permit_vichele_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("manual_permit_vichele", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("manual_permit_vichele", Thrift.MessageType.EXCEPTION, seqid);
