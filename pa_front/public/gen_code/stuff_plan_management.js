...
stuff_plan_management_confirm_deliver_args = class {
  ...
  write (output) {
    ...
    if (this.deliver_infos !== null && this.deliver_infos !== undefined) {
      ...
      for (let iter124 in this.deliver_infos) {
...
stuff_plan_management_export_plan_args = class {
  ...
  write (output) {
    ...
    if (this.plan_ids !== null && this.plan_ids !== undefined) {
      ...
      for (let iter129 in this.plan_ids) {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i147 = 0; _i147 < _size145; ++_i147) {
            let elem148 = null;
            elem148 = new vichele_statistics();
            elem148.read(input);
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i152 = 0; _i152 < _size150; ++_i152) {
            let elem153 = null;
            elem153 = new vichele_search_result();
            elem153.read(input);
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i157 = 0; _i157 < _size155; ++_i157) {
            let elem158 = null;
            elem158 = new vichele_statistics();
            elem158.read(input);
...
stuff_plan_management_driver_silent_reset_args = class {
  constructor(args) {
    this.ssid = null;
    this.silent_id = null;
    if (args) {
...
stuff_plan_management_driver_silent_reset_result = class {
  constructor(args) {
    this.e = null;
    if (args instanceof gen_exp) {
        this.e = args;
...
stuff_plan_management_multi_confirm_plan_args = class {
  ...
  write (output) {
    ...
    if (this.plan_ids !== null && this.plan_ids !== undefined) {
      output.writeFieldBegin('plan_ids', Thrift.Type.LIST, 2);
      output.writeListBegin(Thrift.Type.I64, this.plan_ids.length);
      for (let iter174 in this.plan_ids) {
...
stuff_plan_management_change_driver_args = class {
  constructor(args) {
    this.ssid = null;
    this.vichele_id = null;
...
stuff_plan_management_change_driver_result = class {
  constructor(args) {
    this.success = null;
    this.e = null;
    if (args instanceof gen_exp) {
...
stuff_plan_management_change_plan_price_args = class {
  constructor(args) {
    this.ssid = null;
    this.plan_id = null;
    this.new_price = null;
  ...
  write (output) {
    ...
    if (this.plan_id !== null && this.plan_id !== undefined) {
      ...
      for (let iter179 in this.plan_id) {
...
stuff_plan_management_change_plan_price_result = class {
  constructor(args) {
    this.success = null;
    this.e = null;
    if (args instanceof gen_exp) {
...
stuff_plan_managementClient = class stuff_plan_managementClient {
  ...
  driver_silent_reset (ssid, silent_id) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_driver_silent_reset(ssid, silent_id, (error, result) => {
        return error ? reject(error) : resolve(result);
      });
    });
  }

  send_driver_silent_reset (ssid, silent_id, callback) {
    const params = {
      ssid: ssid,
      silent_id: silent_id
    };
    const args = new stuff_plan_management_driver_silent_reset_args(params);
    try {
      this.output.writeMessageBegin('driver_silent_reset', Thrift.MessageType.CALL, this.seqid);
      args.write(this.output);
      this.output.writeMessageEnd();
      const self = this;
      this.output.getTransport().flush(true, () => {
        let error = null, result = null;
        try {
          result = self.recv_driver_silent_reset();
        } catch (e) {
          error = e;
        }
        callback(error, result);
  ...
  recv_driver_silent_reset () {
    ...
    const result = new stuff_plan_management_driver_silent_reset_result();
    result.read(this.input);
    this.input.readMessageEnd();
  ...
  change_driver (ssid, vichele_id, driver_name, driver_phone) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_change_driver(ssid, vichele_id, driver_name, driver_phone, (error, result) => {
        return error ? reject(error) : resolve(result);
      });
    });
  }

  send_change_driver (ssid, vichele_id, driver_name, driver_phone, callback) {
    const params = {
      ssid: ssid,
      vichele_id: vichele_id,
    ...
    const args = new stuff_plan_management_change_driver_args(params);
    try {
      this.output.writeMessageBegin('change_driver', Thrift.MessageType.CALL, this.seqid);
      args.write(this.output);
      this.output.writeMessageEnd();
      const self = this;
      this.output.getTransport().flush(true, () => {
        let error = null, result = null;
        try {
          result = self.recv_change_driver();
        } catch (e) {
          error = e;
        }
        callback(error, result);
  ...
  recv_change_driver () {
    ...
    const result = new stuff_plan_management_change_driver_result();
    result.read(this.input);
    this.input.readMessageEnd();
    ...
    throw 'change_driver failed: unknown result';
  }

  change_plan_price (ssid, plan_id, new_price) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_change_plan_price(ssid, plan_id, new_price, (error, result) => {
        return error ? reject(error) : resolve(result);
      });
    });
  }

  send_change_plan_price (ssid, plan_id, new_price, callback) {
    const params = {
      ssid: ssid,
      plan_id: plan_id,
      new_price: new_price
    };
    const args = new stuff_plan_management_change_plan_price_args(params);
    try {
      this.output.writeMessageBegin('change_plan_price', Thrift.MessageType.CALL, this.seqid);
      args.write(this.output);
      this.output.writeMessageEnd();
      const self = this;
      this.output.getTransport().flush(true, () => {
        let error = null, result = null;
        try {
          result = self.recv_change_plan_price();
        } catch (e) {
          error = e;
        }
        callback(error, result);
  ...
  recv_change_plan_price () {
    ...
    const result = new stuff_plan_management_change_plan_price_result();
    result.read(this.input);
    this.input.readMessageEnd();
    ...
    throw 'change_plan_price failed: unknown result';
  }
};
