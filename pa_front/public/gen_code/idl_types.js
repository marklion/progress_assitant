  ...
  read (input) {
    ...
    while (true) {
      ...
      switch (fid) {
        ...
        case 22:
        if (ftype == Thrift.Type.I64) {
          this.wait_last = input.readI64().value;
        } else {
          input.skip(ftype);
        }
        break;
  ...
  read (input) {
    ...
    while (true) {
      ...
      switch (fid) {
        ...
        case 27:
        if (ftype == Thrift.Type.I64) {
          this.wait_order = input.readI64().value;
        } else {
          input.skip(ftype);
        }
        break;
...
vichele_stay_alone_statistics = class {
  constructor(args) {
  ...
  read (input) {
    ...
    while (true) {
      ...
      switch (fid) {
        case 1:
        if (ftype == Thrift.Type.I64) {
          this.yestarday_left = input.readI64().value;
        } else {
          input.skip(ftype);
        }
        break;
        case 2:
        if (ftype == Thrift.Type.I64) {
          this.yestarday_total = input.readI64().value;
        } else {
          input.skip(ftype);
        }
        break;
        case 3:
        if (ftype == Thrift.Type.I64) {
          this.today_finish = input.readI64().value;
        } else {
          input.skip(ftype);
        }
        break;
        case 4:
        if (ftype == Thrift.Type.I64) {
          this.today_total = input.readI64().value;
        } else {
          input.skip(ftype);
        }
        break;
