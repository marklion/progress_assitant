...
vichele_management_create_vichele_info_args = class {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i152 = 0; _i152 < _size150; ++_i152) {
            ...
            elem153.read(input);
            this.vichele_info.push(elem153);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  write (output) {
    ...
    if (this.vichele_info !== null && this.vichele_info !== undefined) {
      ...
      for (let iter154 in this.vichele_info) {
        if (this.vichele_info.hasOwnProperty(iter154)) {
          iter154 = this.vichele_info[iter154];
