...
vichele_management_create_vichele_info_args = class {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i137 = 0; _i137 < _size135; ++_i137) {
            ...
            elem138.read(input);
            this.vichele_info.push(elem138);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  write (output) {
    ...
    if (this.vichele_info !== null && this.vichele_info !== undefined) {
      ...
      for (let iter139 in this.vichele_info) {
        if (this.vichele_info.hasOwnProperty(iter139)) {
          iter139 = this.vichele_info[iter139];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i142 = 0; _i142 < _size140; ++_i142) {
            let elem143 = null;
            elem143 = new vichele_stay_alone();
            elem143.read(input);
...
vichele_management_cancel_vichele_args = class {
  ...
  write (output) {
    ...
    if (this.info !== null && this.info !== undefined) {
      output.writeFieldBegin('info', Thrift.Type.LIST, 2);
      output.writeListBegin(Thrift.Type.STRUCT, this.info.length);
      for (let iter164 in this.info) {
        if (this.info.hasOwnProperty(iter164)) {
          iter164 = this.info[iter164];
