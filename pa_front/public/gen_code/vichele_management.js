...
vichele_management_create_vichele_info_args = class {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i182 = 0; _i182 < _size180; ++_i182) {
            ...
            elem183.read(input);
            this.vichele_info.push(elem183);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  write (output) {
    ...
    if (this.vichele_info !== null && this.vichele_info !== undefined) {
      ...
      for (let iter184 in this.vichele_info) {
        if (this.vichele_info.hasOwnProperty(iter184)) {
          iter184 = this.vichele_info[iter184];
...
vichele_management_confirm_vichele_args = class {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i206 = 0; _i206 < _size204; ++_i206) {
            ...
            this.company_for_select.push(elem207);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  write (output) {
    ...
    if (this.info !== null && this.info !== undefined) {
      ...
      for (let iter208 in this.info) {
        if (this.info.hasOwnProperty(iter208)) {
          iter208 = this.info[iter208];
    ...
    if (this.company_for_select !== null && this.company_for_select !== undefined) {
      ...
      for (let iter209 in this.company_for_select) {
        if (this.company_for_select.hasOwnProperty(iter209)) {
          iter209 = this.company_for_select[iter209];
...
vichele_management_cancel_vichele_args = class {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i212 = 0; _i212 < _size210; ++_i212) {
            let elem213 = null;
            elem213 = new vichele_stay_alone();
            elem213.read(input);
            this.info.push(elem213);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  write (output) {
    ...
    if (this.info !== null && this.info !== undefined) {
      output.writeFieldBegin('info', Thrift.Type.LIST, 2);
      output.writeListBegin(Thrift.Type.STRUCT, this.info.length);
      for (let iter214 in this.info) {
        if (this.info.hasOwnProperty(iter214)) {
          iter214 = this.info[iter214];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i227 = 0; _i227 < _size225; ++_i227) {
            let elem228 = null;
            elem228 = new supplier_basic_info();
            elem228.read(input);
...
vichele_management_smart_assign_args = class {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i232 = 0; _i232 < _size230; ++_i232) {
            let elem233 = null;
            elem233 = new vichele_stay_alone();
            elem233.read(input);
            this.vichele_info.push(elem233);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  write (output) {
    ...
    if (this.vichele_info !== null && this.vichele_info !== undefined) {
      output.writeFieldBegin('vichele_info', Thrift.Type.LIST, 2);
      output.writeListBegin(Thrift.Type.STRUCT, this.vichele_info.length);
      for (let iter234 in this.vichele_info) {
        if (this.vichele_info.hasOwnProperty(iter234)) {
          iter234 = this.vichele_info[iter234];
...
vichele_management_change_price_args = class {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (let _i242 = 0; _i242 < _size240; ++_i242) {
            let elem243 = null;
            elem243 = new vichele_stay_alone();
            elem243.read(input);
            this.info.push(elem243);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  write (output) {
    ...
    if (this.info !== null && this.info !== undefined) {
      output.writeFieldBegin('info', Thrift.Type.LIST, 2);
      output.writeListBegin(Thrift.Type.STRUCT, this.info.length);
      for (let iter244 in this.info) {
        if (this.info.hasOwnProperty(iter244)) {
          iter244 = this.info[iter244];
