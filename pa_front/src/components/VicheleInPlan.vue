...
<div class="vichele_in_plan_show">
    ...
    <van-popup v-model="show_main_vichele_picker" position="bottom">
        <van-picker show-toolbar :columns="main_vichele_pool" @confirm="confirm_main_vichele" @cancel="show_main_vichele_picker = false">
            <template #title>
                <van-button type="info" native-type="button" @click="show_add_main_vichele_diag = true">添加车辆</van-button>
            </template>
        </van-picker>
    </van-popup>
    ...
    <van-popup v-model="show_behind_vichele_picker" position="bottom">
        <van-picker show-toolbar :columns="behind_vichele_pool" @confirm="confirm_behind_vichele" @cancel="show_behind_vichele_picker = false">
            <template #title>
                <van-button type="info" native-type="button" @click="show_add_behind_vichele_diag = true">添加车辆</van-button>
            </template>
        </van-picker>
    </van-popup>
...
export default {
    ...
    data: function () {
        return {
            ...
            show_add_main_vichele_diag: false,
            behind_vichele_pool: [],
            show_behind_vichele_picker: false,
            show_add_behind_vichele_diag: false,
            new_vichele: '',
