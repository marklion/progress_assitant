<template>
<div class="ticket_sh">
    <div :id="'ticket_content' + ticket_id" v-if="!whole_pic">
    ...
    <div v-else>
        <van-divider v-if="!no_need_prompt">长按磅单，保存到手机相册</van-divider>
...
export default {
    ...
    methods: {
        ...
        make_pic: function () {
            var vue_this = this;
            var ticket_pic = document.querySelector('#ticket_content' + this.ticket_id);
        ...
        init_ticket: function () {
            var vue_this = this;
            vue_this.$call_remote_process("open_api_management", "get_vehicle_info_by_id", [vue_this.ticket_id]).then(function (resp) {
