...
<div class="company_order_show">
    <van-tabs v-model="active" sticky>
        <van-tab title="全部" >
            <plan-brief v-for="(single_plan, index) in orders" :key="index" :plan_id="single_plan.plan_id" :company_view="true"></plan-brief>
        </van-tab>
        <van-tab title="待确认" :badge="numbers_of_tab(0)">
            <plan-brief v-for="(single_plan, index) in order_need_show" :key="index" :plan_id="single_plan" :company_view="true"></plan-brief>
        </van-tab>
